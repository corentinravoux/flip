...
def H_gv_l1_p1(theta, phi):
    return -2 / 5 * np.cos(phi - 1 / 2 * theta) - 1 / 5 * np.cos(phi + (3 / 2) * theta)
...
def H_gv_l1_p2(theta, phi):
    return -9 / 35 * np.cos(phi - 1 / 2 * theta) - 6 / 35 * np.cos(
        phi + (3 / 2) * theta
    )
...
def H_gv_l1_p3(theta, phi):
    return -4 / 21 * np.cos(phi - 1 / 2 * theta) - 1 / 7 * np.cos(phi + (3 / 2) * theta)
...
def H_gv_l1_p4(theta, phi):
    return -5 / 33 * np.cos(phi - 1 / 2 * theta) - 4 / 33 * np.cos(
        phi + (3 / 2) * theta
    )
